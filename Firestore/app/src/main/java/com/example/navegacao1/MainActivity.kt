            ...
            Navegacao1Theme {
                Scaffold(
                    ...
                    NavHost(navController = navController, startDestination = "login") {
                        composable("login") {
                            TelaLogin(modifier = Modifier.padding(innerPadding), navController = navController)
                        }
                        ...
                        composable("cadastro") {
                            TelaCadastro(modifier = Modifier.padding(innerPadding), navController = navController)
                        }
                    }
                }
            }
